...
:: The loop:
:loop
echo %number% >> %name% :: Write number on last line of the file.
TIMEOUT /T %delay% /NOBREAK > NUL          :: Delay for the amount specified on line 6.

SET number=%num%+1     :: Add one to the number prior to the one before it.
